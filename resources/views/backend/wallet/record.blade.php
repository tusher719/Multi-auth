            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="number" class="form-control" id="main_amount" name="main_amount" placeholder="Main Amount" value="100">
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col-md-2">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3 d-flex align-items-center">
                                ...
                                <a href="#" class="remove_field btn btn-danger btn-sm" style="margin-left: 5px" ><i data-feather="x"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
