        ...
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-md-2">
                    ...
                    <input type="text" class="alert alert-secondary" disabled id="average_amount" name="average_amount"
                        readonly placeholder="Average Amount" />
                </div>
                <div class="col-md-2">
                    <label class="form-label">Total Amount:</label>
                    <input type="text" class="alert alert-light" disabled id="total_amount" name="total_amount" readonly
                        placeholder="Total Amount" />
                </div>
                <div class="col-md-2">
                    <label class="form-label">Total Due:</label>
                    <input type="text" class="alert alert-danger" disabled id="total_due" name="total_due" readonly
                        placeholder="Total Due" />
                </div>
                <div class="col-md-2">
                    <label class="form-label">Total Extra:</label>
                    <input type="text" class="alert alert-success" disabled id="total_extra" name="total_extra" readonly
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3 d-flex align-items-center">
                            <input type="text" class="form-control row_number" name="row_number[]" style="width: 40px"
                                readonly placeholder="Row Number" />
                            ...
                            <input type="number" class="form-control amount" name="amount[]" placeholder="Amount"
                                style="margin-left: 5px" />
                            <input type="text" class="form-control due" disabled name="due[]" readonly placeholder="Due"
                                style="margin-left: 5px" />
                            <input type="text" class="form-control extra" disabled name="extra[]" placeholder="Extra"
                                style="margin-left: 5px" />
                            <a href="#" class="remove_field btn btn-danger btn-sm" style="margin-left: 5px"><i
                                    data-feather="x"></i></a>
                        </div>
                    </div>
                </div>
...
<div class="page-content">
    ...
    <script>
        $(document).ready(function(){
            ...
            $(add_button).click(function(e) {
                e.preventDefault();
                // Check if there are fewer than 9 fields
                if ($(".name").length < 12) {
                    $(wrapper).append('<div class="col-md-6">\n' +
                        '                        <div class="mb-3 d-flex align-items-center">\n' +
                        '                            <input type="text" class="form-control row_number" name="row_number[]" style="width: 40px" readonly placeholder="Row Number"/>\n' +
                        ...
                        '                            <input type="text" class="form-control due" disabled name="due[]" readonly placeholder="Due" style="margin-left: 5px" />\n' +
                        '                            <input type="text" class="form-control extra" disabled name="extra[]" placeholder="Extra" style="margin-left: 5px" />\n' +
                        '                            <a href="#" class="remove_field btn btn-danger btn-sm" style="margin-left: 5px"><i data-feather="x"></i></a></div>');
