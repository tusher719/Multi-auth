...
<div class="page-content">
    ...
    <form id="myForm" action="{{ route('cp.update.students',$info->id) }}" method="POST" enctype="multipart/form-data"
        class="forms-sample">
        @csrf
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select" name="panel_position">
                                        ...
                                        <option value="{{ $item->id }}" {{ $info->panel_id == $item->id ?
                                            'selected' : '' }}>
                                            {{ $item->position }}
                                        </option>
                                        @endforeach
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="js-example-basic-multiple form-select" name="tags[]"
                                        ...
                                        <option value="{{ $item->id }}" @selected($info->tags->contains($item->id))>{{
                                            $item->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="form-check mb-4 my-3">
                            <input type="checkbox" class="form-check-input" name="status" id="checkChecked"
                                value="active" {{ $info->status == 'active' ? 'checked': '' }}>
                        ...
                        <a href="{{ route('all.cp.members') }}" class="btn btn-inverse-secondary mx-3">
                            Back
                        </a>
            ...
            <div class="col-md-3 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <img id="showImage" class="wd-200 rounded"
                                src="{{ (!empty($info->photo)) ? url('uploads/students_img/'.$info->photo) : url('uploads/no_image.jpg') }}"
                                alt="{{ $info->name }}">
                        </div>
